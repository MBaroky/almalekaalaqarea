                        ...
                        <div class="col-sm-8 col-md-12 col-lg-8 text-center" style="padding: 40px 10px;">
                            ...
                            <div class="border rounded-0 rtl tabs" style="margin-top: 33px;">
                                <ul class="nav nav-tabs p-0">
                                    <li class="nav-item"><a class="nav-link active" role="tab" data-toggle="tab" href="#tab-1-1">التعريف</a></li>
                                    <li class="nav-item"><a class="nav-link" role="tab" data-toggle="tab" href="#tab-1-2">التركيب</a></li>
                                </ul>
                ...
                <div class="col">
                    <div class="row row-cols-1 row-cols-lg-2">
                        ...
                        <div class="col-sm-8 col-md-12 col-lg-8 text-center" style="padding: 40px 10px;">
                            ...
                            <div class="border rounded-0 rtl tabs" style="margin-top: 33px;">
                                <ul class="nav nav-tabs p-0">
                                    <li class="nav-item"><a class="nav-link active" role="tab" data-toggle="tab" href="#tab-2-1">التعريف</a></li>
                                    <li class="nav-item"><a class="nav-link" role="tab" data-toggle="tab" href="#tab-2-2">التركيب</a></li>
                                </ul>
                                <div class="tab-content">
                ...
                <div class="col">
                    <div class="row row-cols-1 row-cols-lg-2">
                        ...
                        <div class="col-sm-8 col-md-12 col-lg-8 text-center" style="padding: 40px 10px;">
                            ...
                            <div class="border rounded-0 rtl tabs" style="margin-top: 33px;">
                                <ul class="nav nav-tabs p-0">
                                    <li class="nav-item"><a class="nav-link active" role="tab" data-toggle="tab" href="#tab-3-1">التعريف</a></li>
                                    <li class="nav-item"><a class="nav-link" role="tab" data-toggle="tab" href="#tab-3-2">التركيب</a></li>
                                </ul>
                                <div class="tab-content">
